...
def resolve_weight_path(env_name, relative_path):
    """Resolve a checkpoint from an optional environment variable or the repo."""
...
class KSVQE(nn.Module):
    ...
    def __init__(
        ...
        self.pretrained = pretrained or resolve_weight_path(
            "KSVQE_SWIN_WEIGHTS",
            "pretrained_weights/swin_tiny_patch244_window877_kinetics400_1k.pth",
        )
        ...
        contrique_path = resolve_weight_path(
            "KSVQE_CONTRIQUE_WEIGHTS",
            "pretrained_weights/CONTRIQUE_checkpoint25.tar",
        )
        self.distortion_tool.load_state_dict(torch.load(contrique_path, map_location="cpu"))
    ...
    def load_swin(self, load_path, strict=False):
        ...
        msg = self.load_state_dict(clean_dict, strict=strict)
        print(
            'load swin from kk:',
